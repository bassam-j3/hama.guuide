...
import { useAuth } from '../../hooks/useAuth'; // 🚀 استيراد هوك الصلاحيات
...
// 🚀 1. نقلنا المكونات المساعدة للخارج لمنع مشاكل الـ Re-render وفقدان الـ State
...
const Sidebar = ({ closeSidebar }) => {
    ...
    // 🚀 2. استخدام الهوك الاحترافي بدلاً من القراءة اليدوية
                ...
                <nav className="nav nav-pills flex-column gap-1">
                    ...
                    {isSuperAdmin && (
                        <>
                            ...
                            <SidebarItem to="/admin/sections" icon={<Folder2Open size={18} />} label="إدارة الأقسام" closeSidebar={closeSidebar} />
                            <SidebarItem to="/admin/services" icon={<Grid size={18} />} label="إدارة الخدمات" closeSidebar={closeSidebar} />
                            <SidebarItem to="/admin/schema" icon={<Diagram3 size={18} />} label="إدارة المخططات" closeSidebar={closeSidebar} /> {/* 🚀 تمت إضافته */}
